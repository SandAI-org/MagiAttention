...
@dataclass
class MagiFSDPMeshInfo(DataParallelMeshInfo):
    def __post_init__(self):
        super().__post_init__()
...
@dataclass
class MagiHSDPMeshInfo(MagiFSDPMeshInfo, DDPMeshInfo):
    def __post_init__(self):
        # Calls `MagiFSDPMeshInfo` -> `DDPMeshInfo` -> `DataParallelMeshInfo`
        super().__post_init__()


class TrainingState(Enum):
    """Describes the training state of one MagiFSDP state / parameter group."""
