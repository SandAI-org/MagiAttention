...
from magi_fsdp._fsdp_module import MagiFSDPModule as FSDP2
...
def _discover_ddp_ignored_params(module: torch.nn.Module, prefix: str):
    ...
    if isinstance(module, FSDP2):
        ddp_ignore_parameters = [name for name, _ in module.named_parameters(prefix)]  # type: ignore[attr-defined]
    else:
