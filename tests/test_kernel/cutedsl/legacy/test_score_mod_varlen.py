...
from score_mod_definitions import score_mod_rel_bias  # isort: split
from score_mod_definitions import score_mod_rel_bias as score_mod_rel_bias_vectorized
...
def test_varlen_with_global_idx_score_mod(
    ...
    assert (
        out_cute_final.shape == out_ref_final.shape
