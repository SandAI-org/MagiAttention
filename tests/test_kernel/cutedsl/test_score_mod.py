...
import pytest
import torch
from score_mod_definitions import alibi_eager as alibi_bias_eager
from score_mod_definitions import batch_bias_factory as batch_bias
from score_mod_definitions import block_diagonal_eager
from score_mod_definitions import (
    causal_eager as causal_mask_eager,  # Eager (torch) reference score mods
)
from score_mod_definitions import causal_v2_eager as causal_mask_v2_eager
from score_mod_definitions import dual_buffer_factory as dual_buffer_bias
from score_mod_definitions import rel_bias_eager as relative_bias_eager
from score_mod_definitions import rel_bias_x2_eager as relative_bias_v2_eager
from score_mod_definitions import score_mod_alibi as score_mod_6
from score_mod_definitions import score_mod_alibi_vectorized as score_mod_6_vectorized
from score_mod_definitions import score_mod_batch_bias as score_mod_10
from score_mod_definitions import (
    score_mod_batch_bias_vectorized as score_mod_10_vectorized,
)
from score_mod_definitions import score_mod_block_diagonal as score_mod_8
from score_mod_definitions import score_mod_causal as score_mod_2
from score_mod_definitions import score_mod_causal_v2 as score_mod_9
from score_mod_definitions import score_mod_causal_vectorized as score_mod_2_vectorized
from score_mod_definitions import score_mod_dual_buffer as score_mod_11
from score_mod_definitions import (
    score_mod_dual_buffer_vectorized as score_mod_11_vectorized,
)
from score_mod_definitions import (
    score_mod_identity as score_mod_1,  # TensorSSA-based score mods; isort: split
)
from score_mod_definitions import (
    score_mod_identity_vectorized as score_mod_1_vectorized,  # isort: split
)
from score_mod_definitions import score_mod_rel_bias as score_mod_3
from score_mod_definitions import score_mod_rel_bias as score_mod_3_vectorized
from score_mod_definitions import score_mod_rel_bias_x2 as score_mod_4
from score_mod_definitions import (
    score_mod_rel_bias_x2_vectorized as score_mod_4_vectorized,
)
from score_mod_definitions import score_mod_sliding_window as score_mod_7
from score_mod_definitions import score_mod_times_two as score_mod_5
from score_mod_definitions import (
    score_mod_times_two_vectorized as score_mod_5_vectorized,
)
from score_mod_definitions import sliding_window_eager, times_two_eager
from torch.nn.attention.flex_attention import create_block_mask, flex_attention

from magi_attention.kernel.cutedsl.block_sparsity import BlockSparseTensorsTorch
...
@pytest.mark.parametrize("score_mod_pair", TEST_PAIRS)
@pytest.mark.skipif(
    COMPUTE_CAPABILITY != 10, reason="Paged KV cache only supported on SM100"
)
...
def test_sm90_block_sparse_score_mod_backward_with_dq_swapab():
    ...
    def run_flex_block_sparse_score_mod_ref(
        q_ref, k_ref, v_ref, grad_out_ref, ref_dtype=None
    ):
    ...
    (
        ...
        dk_ref_fp32,
        dv_ref_fp32,
    ) = run_flex_block_sparse_score_mod_ref(
...
def test_cute_vs_flex_attention_backward(
    seqlen_q, seqlen_kv, dim, dtype, score_mod_triple, use_autograd
):
    ...
    out_cute, grad_out, dq_cute, dk_cute, dv_cute = run_cute_flash_bwd(
        q, k, v, cute_fwd, cute_bwd, use_autograd=use_autograd
    )
...
def make_aux_tensors_for_bwd(
    cute_score_mod, eager_factory, seqlen_q, num_heads, batch_size, dtype
):
    if cute_score_mod == score_mod_10:
        buffer = torch.randn(batch_size, device="cuda", dtype=dtype) * 0.1
