...
template <int Arch, int kHeadDim, int ClusterM, typename Element, typename ElementOut, bool Has_softcap>
void run_flash_fwd(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    using CollectiveEpilogue = flash::CollectiveEpilogueFwd<TileShape_MNK_PV, ClusterShape, ElementOut, ArchTag, CollectiveMainloop::NumMmaThreads, false>;
    ...
    typename flash::TileSchedulerArguments scheduler_args {
        num_blocks_m, params.h_qo, params.b, params.num_splits,
...
void run_mha_fwd_(Flash_fwd_params &params, cudaStream_t stream) {
    ...
    CLUSTER_SWITCH(cutlass::ceil_div(params.total_q, kBlockM) % 2 == 0, Use_cluster, [&] {
        ...
        run_flash_fwd<Arch, kHeadDim, ClusterM, T, T_out, Has_softcap>(params, stream);
    });
}
