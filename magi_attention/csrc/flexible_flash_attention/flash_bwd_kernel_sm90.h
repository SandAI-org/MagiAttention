...
class FlashAttnBwdSm90 {
 public:
  ...
  static constexpr uint32_t LoadRegisterRequirement = !SparseLoad ? 40 : 88;
  static constexpr uint32_t MmaRegisterRequirement = !SparseLoad ? (NumMmaWarpGroups == 2 ? 232 : 152) : 208;
