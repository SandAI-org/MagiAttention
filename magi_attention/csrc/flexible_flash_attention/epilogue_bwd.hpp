...
template <class TileShape_MNK_, class Element_, class ElementAccum_, class ArchTag_,
          int NumEpilogueThreads_, bool dKV_swapAB_, int AtomLayoutKdKV=1, bool DisableBwdDkvAtomicReduction_=false>
struct CollectiveEpilogueBwd {
    ...
    using GmemTiledCopydKVTMA = std::conditional_t<
