...
template <int Arch, int kHeadDim, int kBlockM, int kBlockN, bool Has_softcap,
          typename Element, typename ElementDkv, bool Deterministic, 
          ...
          bool V_in_regs=false, bool RangeMerge=false, bool DisableBwdDkvAtomicReduction=false>
void run_flash_bwd(Flash_bwd_params &params, cudaStream_t stream) {
    ...
    using CollectiveEpilogue = flash::CollectiveEpilogueBwd<TileShape_MNK, ElementDkv, ElementAccum, ArchTag, CollectiveMainloop::NumMmaThreads, dKV_swapAB, NumMmaWarpGroups * (Arch >= 90 ? 1 : cutlass::NumWarpsPerWarpGroup) / AtomLayoutNdKV, DisableBwdDkvAtomicReduction>;
    ...
    using Scheduler = flash::DynamicPersistentTileScheduler<kBlockN, CollectiveMainloop::NumMmaThreads, CollectiveMainloop::NumProducerThreads, Arch >= 90 /*WarpSpecialized*/>;
