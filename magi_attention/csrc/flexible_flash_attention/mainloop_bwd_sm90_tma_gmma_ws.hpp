 ...
 ******************************************************************************/
 ...
 struct CollectiveMainloopBwdSm90 {
   ...
   using SmemLayoutLSE = cute::Layout<cute::Shape<Int<4>, Int<kBlockM>, Int<kStages>>, cute::Stride<_1, Int<4>, Int<4 * cute::round_up(kBlockM, 64)>>>;
   ...
   CUTLASS_DEVICE bool load(
     ...
     Tensor gLSE = local_tile(cute::domain_offset(make_coord(_0{}, seqlen_info.offset_q), mLSE), make_shape(get<0>(shape(mLSE)), select<0>(TileShape_MNK{})), make_coord(_0{}, _)); // (4, M, _)
     Tensor gdPsum = local_tile(cute::domain_offset(make_coord(_0{}, seqlen_info.offset_q), mdPsum), make_shape(get<0>(shape(mdPsum)), select<0>(TileShape_MNK{})), make_coord(_0{}, _)); // (4, M, _)
