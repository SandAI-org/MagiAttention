...
def compute_sparse_kv_metadata(
    arg0: torch.Tensor,
    arg1: torch.Tensor,
    arg2: torch.Tensor,
    ...
    """
    Compute sparse KV metadata (loop count, invalid count, equal flag, flat token ids) for each unique Q range
    """
