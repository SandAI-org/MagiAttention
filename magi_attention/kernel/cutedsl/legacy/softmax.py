...
import magi_attention.kernel.cutedsl.legacy.utils as utils
            ...
            for k in cutlass.range_constexpr(0, cute.size(acc_S_row_frg, mode=[0]), 2):
                ...
                if cutlass.const_expr(ex2_emu_freq == 0):
                    ...
                    if cutlass.const_expr(
                        ...
                        # acc_S_row_frg[k, j], acc_S_row_frg[k + 1, j] = utils.e2e_asm2(acc_S_row_frg[k, j], acc_S_row_frg[k + 1, j])  # noqa: E501
                        (
                            acc_S_row_frg[k, j],
                            acc_S_row_frg[k + 1, j],
