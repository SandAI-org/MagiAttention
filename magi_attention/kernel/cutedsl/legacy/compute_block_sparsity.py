...
from magi_attention.kernel.cutedsl.legacy.utils import (
    hash_callable,
    scalar_to_ssa,
    ssa_to_scalar,
)
...
def compute_block_sparsity(
    ...
    Args:
        ...
        use_fast_sampling: Whether to use 5-point sampling (4 corners + center).
            This is much faster, but only suitable for masks where this check is sufficient.
