...
class AttnRangeProtocol(Protocol):
    ...
    def truncate(self, start: int | None = None, end: int | None = None) -> AttnRangeProtocol: ...
...
class AttnRangesProtocol(Protocol):
    ...
    def insert(self, idx: int, attn_range: AttnRangeProtocol, check: bool = False) -> None: ...
    ...
    def merge_with_split_alignment(self, split_alignment: int = 1) -> AttnRangesProtocol: ...
    def chunk(self, chunk_size: int, check: bool = True) -> list[AttnRangesProtocol]: ...
    def truncate(self, start: int | None = None, end: int | None = None) -> AttnRangesProtocol: ...
...
class AttnRectangleProtocol(Protocol):
    ...
    def cut_q(self, cut_pos: int) -> tuple[AttnRectangleProtocol | None, AttnRectangleProtocol | None]: ...
    def cut_k(self, cut_pos: int) -> tuple[AttnRectangleProtocol | None, AttnRectangleProtocol | None]: ...
    def get_rect_within_q_segment(self, q_start: int, q_end: int) -> AttnRectangleProtocol | None: ...
    def get_rect_within_k_segment(self, k_start: int, k_end: int) -> AttnRectangleProtocol | None: ...
...
class AttnRectanglesProtocol(Protocol):
    ...
    def cut_q(self, cut_pos: int) -> tuple[AttnRectanglesProtocol, AttnRectanglesProtocol]: ...
    def cut_k(self, cut_pos: int) -> tuple[AttnRectanglesProtocol, AttnRectanglesProtocol]: ...
    def get_rects_within_q_segment(self, q_start: int, q_end: int) -> AttnRectanglesProtocol: ...
    def get_rects_within_k_segment(self, k_start: int, k_end: int) -> AttnRectanglesProtocol: ...
